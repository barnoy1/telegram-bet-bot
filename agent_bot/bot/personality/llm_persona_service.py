...
class LLMPersonalityService:
    ...
    def __init__(self, base_url: str = None, model: str = None):
        ...
        self.timeout = 10  # seconds - reduced from 30 to prevent blocking
...
IMPORTANT: Stay in character for the entire session. Maintain the Sleazy persona consistently across all responses.
...
Response:"""
    ...
    async def get_new_player_response(self, username: str) -> Optional[str]:
...
Response:"""
    ...
    async def get_hesitation_response(self) -> Optional[str]:
